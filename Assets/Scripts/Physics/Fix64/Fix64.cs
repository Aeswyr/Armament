...
namespace FixMath.NET
{
    ...
    {
        [SerializeField] private long m_rawValue;
        ...
        public static readonly Fix64 Half = One / (Fix64)2;
        /// <summary>
        /// The value of Pi
        /// </summary>
        ...
        public string FixedToString() {
            ...
            long dec = (tmp * (Fix64)IntPow(10, 4)).m_rawValue / ONE;
        ...
        public static Fix64 Parse(string val) {
            if (val.Contains('.')) {
                ...
                return new Fix64((long)(int.Parse(val) * ONE));
        }
...
@"
        ...
        public class Fix64Drawer : PropertyDrawer {
            public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
                ...
                SerializedProperty raw = property.FindPropertyRelative(nameof(Fix64.m_rawValue));
                Fix64 val = new Fix64(raw.longValue);
                ...
                string text = EditorGUI.TextField(dataRect, val.FixedToString());

                if (raw.longValue != Fix64.Parse(text).m_rawValue)
                    raw.longValue = Fix64.Parse(text).m_rawValue;
